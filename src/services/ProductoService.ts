  ...
  static async inicializarDatosPrueba(): Promise<void> {
    ...
    if (productos.length === 0) {
      const productosIniciales = [
        { nombre: 'Bidón 20L', cantidad: 45, precio: 25.00, minimo: 10 },
        { nombre: 'Bidón 10L', cantidad: 8, precio: 15.00, minimo: 10 },
        { nombre: 'Botella 1L', cantidad: 120, precio: 3.50, minimo: 50 },
        { nombre: 'Botella 500ml', cantidad: 5, precio: 2.00, minimo: 20 },
        { nombre: 'Bidón 5L', cantidad: 25, precio: 8.00, minimo: 15 }
      ];
